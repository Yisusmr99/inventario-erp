                                ...
                                <div>
                                    ...
                                    <div className="mt-2">
                                        <input
                                            ...
                                            maxLength={100}
                                            className={`block w-full rounded-md border-0 py-1.5 px-1.5 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 ${errors.nombre
                                        ...
                                        <p className="mt-1 text-sm text-gray-500 px-1.5">
                                ...
                                <div>
                                    ...
                                    <div className="mt-2">
                                        <textarea
                                            ...
                                            className={`block w-full rounded-md border-0 py-1.5 px-1.5 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 ${errors.descripcion
                                                    ? 'ring-red-300 focus:ring-red-500'
                                                    : 'ring-gray-300 focus:ring-indigo-600'
                                                }`}
